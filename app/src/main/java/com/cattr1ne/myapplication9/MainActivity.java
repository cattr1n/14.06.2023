package com.cattr1ne.myapplication9;
        ...
        try {
            switch (view.getId()) {
                ...
                case R.id.btnRAW:
                    ...
                    toast.show(); // демонстрация тоста на экране
                    mediaPlayer = MediaPlayer.create(this, R.raw.txt_tinnitus); // создание дорожки с имеющимся аудио-файлом
                    mediaPlayer.start(); // старт данной дорожки
                    nameAudio = "TXT - Tinnitus"; // инициализация названия контента
                    break;
                case R.id.btnSD:
